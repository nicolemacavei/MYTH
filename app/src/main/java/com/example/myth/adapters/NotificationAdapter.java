        ...
        void setNotificationData(User user){
            ...
            binding.acceptUserBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    database.collection(Constants.KEY_COLLECTION_USERS).document(currentUID)
                            .collection(Constants.KEY_COLLECTION_CONNECTION).document(user.getUserId()).set(user);
                    ...
                    database.collection(Constants.KEY_COLLECTION_USERS).document(user.getUserId())
                            .collection(Constants.KEY_COLLECTION_CONNECTION).document(currentUID).set(currentUser);
